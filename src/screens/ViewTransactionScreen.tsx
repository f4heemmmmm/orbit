  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.background }}>
      ...
      <View className="flex-1" style={{ backgroundColor: COLORS.background }}>
        ...
        {/* Amount Card */}
        <View className="mx-4 mt-4 rounded-2xl p-6 items-center" style={{ backgroundColor: COLORS.card }}>
          <Text
          ...
          <View
            ...
            style={{ backgroundColor: (isIncome ? COLORS.pastel.green : COLORS.pastel.red) + '20' }}
          >
            <Text
        ...
        <View className="mx-4 mt-4 rounded-2xl p-5" style={{ backgroundColor: COLORS.card }}>
          ...
          <View className="flex-row items-center mb-5">
            ...
            <View className="ml-4 flex-1">
              <Text style={{ color: COLORS.text.secondary }} className="text-sm">Title</Text>
          ...
          <View className="flex-row items-center mb-5">
            ...
            <View className="ml-4 flex-1">
              <Text style={{ color: COLORS.text.secondary }} className="text-sm">Date</Text>
              <Text style={{ color: COLORS.text.primary }} className="text-lg font-medium mt-0.5">
          ...
          <View className="flex-row items-center">
            ...
            <View className="ml-4 flex-1">
              <Text style={{ color: COLORS.text.secondary }} className="text-sm">Amount</Text>
              <Text style={{ color: COLORS.text.primary }} className="text-lg font-medium mt-0.5">
        ...
        {transaction.description ? (
          <View className="mx-4 mt-4 rounded-2xl p-5" style={{ backgroundColor: COLORS.card }}>
            <View className="flex-row items-center mb-3">
              ...
              <Text style={{ color: COLORS.text.secondary }} className="text-sm ml-4">Description</Text>
            </View>
